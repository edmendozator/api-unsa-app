...
class GradeController extends Controller
{
    ...
    {      
        ...
        $asignaturas_desaprobadas = DB::connection('conexion_siac')->select("SELECT a.casi as codigo, b.nasi as asignatura, a.nota, a.core as estado, b.cred as creditos, CONCAT(a.anoh, '-', a.cicl) as periodo 
                                        FROM acdl" . $nues . "=a,actasig=b,SIAC_NOTA_APRO=c 
                                        WHERE a.casi=b.casi AND b.nues=? AND b.nues=c.codi_depe AND a.anoh=c.nota_anoh 
